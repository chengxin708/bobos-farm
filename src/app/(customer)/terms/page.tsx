      ...
      <div className="max-w-[680px] mx-auto px-4 py-12 lg:py-20">
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-base text-[#6B6157] leading-[1.8] font-sans">{t('acceptance.body')}</p>
          </section>

          {/* Booking & Cancellation */}
          <section className="space-y-4">
            <h2 className="font-serif text-xl font-bold text-[#1A1208]">{t('booking.title')}</h2>
            <p className="text-base text-[#6B6157] leading-[1.8] font-sans">{t('booking.body')}</p>
          </section>

          {/* Deposits */}
          <section className="space-y-4">
            <h2 className="font-serif text-xl font-bold text-[#1A1208]">{t('deposits.title')}</h2>
            <p className="text-base text-[#6B6157] leading-[1.8] font-sans">{t('deposits.body')}</p>
          </section>

          {/* Liability */}
          <section className="space-y-4">
            <h2 className="font-serif text-xl font-bold text-[#1A1208]">{t('liability.title')}</h2>
            <p className="text-base text-[#6B6157] leading-[1.8] font-sans">{t('liability.body')}</p>
          </section>

          {/* Governing Law */}
          <section className="space-y-4">
            <h2 className="font-serif text-xl font-bold text-[#1A1208]">{t('governingLaw.title')}</h2>
            <p className="text-base text-[#6B6157] leading-[1.8] font-sans">{t('governingLaw.body')}</p>
          </section>
        </div>
      </div>
    </div>
