    ...
    <div className="flex h-screen">
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-16">
          <h2 className="font-playfair text-[44px] font-bold text-white text-center leading-tight">Welcome Back{'\n'}to the Farm</h2>
          <p className="text-white/70 text-base mt-4 text-center">Your table in the Hudson Valley awaits</p>
        </div>
      </div>
      <div className="flex-1 bg-cream flex items-center justify-center">
        <div className="w-[420px] bg-white rounded-[20px] p-10 shadow-[0_4px_40px_rgba(0,0,0,0.03)] flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-1.5">
            <h1 className="font-playfair text-[28px] font-bold text-brown">Sign In</h1>
            <p className="text-sm text-brown/53">Welcome back! Please enter your details.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4.5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
                ...
                <span className="text-[13px] text-brown">Remember me</span>
              </label>
              <a href="#" className="text-[13px] font-medium text-amber no-underline">Forgot password?</a>
            </div>
          ...
          <div className="flex justify-center gap-1">
            <span className="text-[13px] text-brown/53">Don&apos;t have an account?</span>
            <Link href="/register" className="text-[13px] font-semibold text-amber no-underline">Sign up</Link>
          </div>
        </div>
      </div>
    </div>
