...
import { Users, UtensilsCrossed, Tent, BarChart3, Calendar, Settings, ChevronRight } from 'lucide-react'
...
const links = [
  ...
  { href: '/admin/holidays', icon: Calendar, labelKey: 'holidays' as const, descKey: 'holidaysDesc' as const },
