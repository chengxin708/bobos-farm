...
export function ConvertInquiryModalDesktop({
  isOpen,
  onClose,
  onViewReservation,
  form,
  ...
  return (
    <div
      className={`fixed inset-0 z-[70] flex items-center justify-center p-6 transition-all duration-200 ${
    ...
    >
      ...
      >
        <div className="shrink-0 flex items-center justify-between px-6 py-4 border-b border-[#E8E2D9]">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg hover:bg-[#F5F2ED] border-none bg-transparent cursor-pointer"
        ...
        {inSuccess ? (
          ...
          <>
            <form
              id="convert-inquiry-form-desktop"
            ...
            <div className="shrink-0 flex items-center justify-end gap-3 px-6 py-4 border-t border-[#E8E2D9] bg-white">
              <button
                type="button"
                onClick={onClose}
                className="px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-[#F5F2ED] border-none bg-transparent cursor-pointer"
                style={{ color: "#2C2416" }}
              >
                {form.t("cancel")}
              </button>
              <button
                type="submit"
                form="convert-inquiry-form-desktop"
                disabled={form.submitting}
                className="px-5 py-2.5 rounded-lg text-sm font-semibold text-white border-none disabled:opacity-60 flex items-center gap-2 cursor-pointer"
