...
/**
 * Desktop layout: centered dialog capped at viewport height, with a sticky
 * header and sticky footer. The middle section scrolls internally so long
 * forms never push buttons off-screen. Two-column field grid for density.
 */
export function CreateReservationModalDesktop({ isOpen, onClose, form }: Props) {
    ...
    >
      ...
      >
        <div className="shrink-0 flex items-center justify-between px-6 py-4 border-b border-[#E8E2D9]">
          <h2 className="text-xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#2C2416" }}>
            {form.t("title")}
          </h2>
          <button
            onClick={onClose}
        ...
        <form
          ...
          id="create-reservation-form-desktop"
        ...
        <div className="shrink-0 flex items-center justify-end gap-3 px-6 py-4 border-t border-[#E8E2D9] bg-white">
          ...
          <button
            type="submit"
            form="create-reservation-form-desktop"
